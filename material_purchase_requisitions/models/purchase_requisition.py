...
#                            }
    ...
    def show_picking(self):
        ...
        po_id = self.env['purchase.order'].search([('custom_requisition_id', '=', self.id)])
        picking_id = self.env['stock.picking'].search([('id','in', po_id.picking_ids.ids)])
        res['domain'] = str(['|',('id','in',picking_id.ids),('custom_requisition_id', '=', self.id)])
        return res

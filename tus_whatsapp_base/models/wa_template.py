...
class WATemplate(models.Model):
    ...
    def init(self):
        video_path = get_module_resource('tus_whatsapp_base', 'static/src/video', 'wa-demo-video.mp4')
        ...
        pdf_path = get_module_resource('tus_whatsapp_base', 'static/src/pdf', 'TestPDFfile.pdf')
        ...
        pdf_path = get_module_resource('tus_whatsapp_base', 'static/src/image', 'whatsapp_default_set.png')
    ...
    #     domain = []
    #     if self.env.user and self.env.user.provider_id:
    #         domain =  [('id','in',self.env.user.provider_id.ids)]
    #     return domain

    name = fields.Char('Name', translate=True, required=True)
    provider_id = fields.Many2one('provider', 'Provider', default=lambda self: self.env.user.provider_id)
    ...
    category = fields.Selection([('auto_reply', 'AUTO_REPLY'),
                                 ...
                                 ('marketing', 'MARKETING')],
                                'Category', default='alert_update', required=True)
    ...
    # def init(self):
    #     video_path = get_module_resource('tus_whatsapp_base', 'static/src/video', 'whatsapp_in_chatter.mp4')
